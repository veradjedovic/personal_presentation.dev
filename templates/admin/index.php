...
<body class="padTop53 " >
    ...
    <div id="wrap">
       ...
       <div id="left">
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel">
                    <a href="admin/#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <li class=""><a href="admin/1"><i class="icon-angle-right"></i> Buttons </a></li>
                         <li class=""><a href="admin/2"><i class="icon-angle-right"></i> Icons </a></li>
                        <li class=""><a href="admin/4"><i class="icon-angle-right"></i> Progress </a></li>
                        <li class=""><a href="admin/"><i class="icon-angle-right"></i> Tabs & Panels </a></li>
                        <li class=""><a href="admin/"><i class="icon-angle-right"></i> Notification </a></li>
                         <li class=""><a href="admin/"><i class="icon-angle-right"></i> More Notification </a></li>
                        <li class=""><a href="admin/"><i class="icon-angle-right"></i> Modals </a></li>
                          <li class=""><a href="admin/"><i class="icon-angle-right"></i> Wizard </a></li>
                         <li class=""><a href="admin/"><i class="icon-angle-right"></i> Sliders </a></li>
                        <li class=""><a href="admin/"><i class="icon-angle-right"></i> Typography </a></li>
                    </ul>
                </li>
                <li class="panel">
                ...
                <li><a href="grid.html"><i class="icon-columns"></i> Grid </a></li>
                  <li class="panel active">
                    ...
                    <ul class="in" id="blank-nav">
                        ...
                        <li><a href="admin/#"><i class="icon-angle-right"></i> Blank Page One  </a></li>
                        <li><a href="admin/#"><i class="icon-angle-right"></i> Blank Page Two  </a></li>
                    </ul>
                </li>
   ...
   <!-- FOOTER -->
    <div id="footer">
        <p>&copy;  personalpresentation &nbsp;2017 &nbsp;</p>
    </div>
    <!--END FOOTER -->
     <!-- GLOBAL SCRIPTS -->
    <script src="templates/admin/assets/plugins/jquery-2.0.3.min.js"></script>
     <script src="templates/admin/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="templates/admin/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    <!-- END GLOBAL SCRIPTS -->
</body>
    <!-- END BODY-->
