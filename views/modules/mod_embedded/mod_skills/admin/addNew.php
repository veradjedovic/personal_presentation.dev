                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapse2" class="body collapse in">
                                    ...
                                    <form class="formInsert form-horizontal" id="popup-validation" action="admin-skills/" method="post">                        
                                        <input type="hidden" name="_method" value="patch" />
                                                   
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Name *</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="validate[required] form-control" name="tb_name" id="req" placeholder="Enter a skill..." />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                    <input type="text" class="validate[required] form-control" name="tb_persentage" id="req" placeholder="Enter a percent..." />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox col-lg-4">
                                                <label>
                                                    <!--<div class="col-lg-4">-->
                                                        <input name="tb_status" type="checkbox" value="" />Check if you want this skill will be visible on the web
                                                    <!--</div>-->
                                                </label>
                                            </div>
                                        </div>
