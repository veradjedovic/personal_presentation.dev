        ...
        <div class="box">
            ...
            <div id ="message" class="">
                ...
                <div id="collapse2" class="body collapse in">
                    <form class="formInsert form-horizontal" id="popup-validation" action="admin-comments/" method="post">
                        <div class="form-group">
                            <label class="control-label col-lg-4">Approved</label>
                            <div class="checkbox col-lg-4">
                                <label>
                                    <!--<div class="col-lg-4">-->
                                    <input name="tb_status" type="checkbox" value="" />Check to approve this comment
                                    <!--</div>-->
                                </label>
                            </div>
                        </div>
                                ...
                                <div id="div-3" class="body tab-content">
                                    <div class="tab-pane fade active in" id="markdown">
                                        <div class="wmd-panel">
                                            ...
                                            <textarea class="form-control" name="ta_content" rows="10" id="wysihtml5"></textarea>
                                        </div>
                                    </div>
                        ...
                        <div style="text-align:center" class="form-actions no-margin-bottom">
                            <input id="submit" type="submit" name="btn_submit" value="Add New Comment" class="btn btn-primary btn-lg" />
                        </div>
                    </form>
                </div>
