                                ...
                                <div id="collapse2" class="body collapse in">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div id="prewAvatar" class="fileupload-new thumbnail" style="width: 200px; height: 200px;"><img src="<?php echo $data['article']->image ? SITE_ROOT . '/resources/images/img_for_articles/' . replace($data['article']->image) : SITE_ROOT .'/templates/admin/assets/img/demoBig.jpg'; ?>" alt="" /></div>
                                    ...
                                    <form class="formInsert form-horizontal" id="popup-validation" action="admin-articles-update/<?php echo $data['article']->id ? $data['article']->id : ''; ?>" method="post">                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" class="validate[required] form-control" name="tb_title" id="req" value="<?php echo $data['article']->title ? replace($data['article']->title) : '' ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <?php foreach($data['pages'] as $page) { ?>
                                                    ...
                                                    <option <?php echo ($data['article']->page_id == $page->id) ? 'selected' : '' ?> value="<?php echo $page->id ? $page->id : 1; ?>"><?php echo $page->name? replace($page->name) : ''; ?> <?php echo ($page->status == WEB_NOT_VISIBLE) ? '(not visible)' : ''; ?></option>
                                                ...
                                                <div id="div-3" class="body tab-content">
                                                    <div class="tab-pane fade active in" id="markdown">
                                                        <div class="wmd-panel">
                                                            ...
                                                            <textarea class="form-control" name="ta_content" rows="10" id="wysihtml5"><?php echo $data['article']->content ? replace($data['article']->content) : ''; ?></textarea>
                                                        </div>
                                                    </div>
