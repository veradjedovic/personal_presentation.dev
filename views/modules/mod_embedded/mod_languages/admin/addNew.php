                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapse2" class="body collapse in">
                                    ...
                                    <form class="formInsert form-horizontal" id="popup-validation" action="admin-languages/" method="post">                        
                                                   
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Name *</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="validate[required] form-control" name="tb_name" id="req" placeholder="Enter a language..." />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox col-lg-4">
                                                <label>
                                                    <!--<div class="col-lg-4">-->
                                                        <input name="tb_status" type="checkbox" value="" />Check if you want this language will be visible on the web
                                                    <!--</div>-->
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div style="text-align:center" class="form-actions no-margin-bottom">
                                            <input id="submit" type="submit" name="btn_submit" value="Add New Language" class="btn btn-primary btn-lg " />
                                        </div>
                                    </form>
                                </div>                            
                            </div>
