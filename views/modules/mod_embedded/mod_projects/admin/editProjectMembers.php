                            ...
                            <div class="panel-body">
                                <div class="table-responsive">                                                         
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <form class="formInsert" method="post" action="admin-projects-members-insert/<?php echo $data['project_id'] ? $data['project_id'] : ''; ?>" >
                                                    <tr>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            Delete Team Member <?php echo isset($data['messageException']) ? ' - ' . $data['messageException'] : '';  ?>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">                                                         
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody id="table_del">
                                        ...
                                        <?php 
                                            if(isset($data['projectMembers'])) {

                                                foreach ($data['projectMembers'] as $item) {                                          
                                        ...
                                        <tr id="row<?php echo ($item->id) ? $item->id : 1; ?>" class="odd gradeX">
                                            ...
                                            <td><?php 
                                                ...
                                                ?>
                                                <center>
                                                    <a class="deleteBtn" href="admin-projects-members-delete/<?php echo ($item->id) ? $item->id : 1; ?>">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.error == false) {
                    ...
                    $('#table_del').append('<tr id="row' + response.projectMember.id + '"><td>' + response.projectMember.author_name + ' ' + response.projectMember.author_surname + '</td><td><center><a class="deleteBtn" href="admin-projects-members-delete/' + response.projectMember.id + '"><i class="submit icon-trash"></i></a></center></td></tr>');
                } else {
