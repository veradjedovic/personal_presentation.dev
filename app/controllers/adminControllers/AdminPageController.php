   ...
   /**
    ...
    public function index()
    {
        try {
            ...
            $this->view('modules/mod_embedded/mod_pages/admin/index', ['adminMenu' => $adminMenu]);
    ...
    public function insert()
    {
        try {
            ...
            $this->view('modules/mod_embedded/mod_pages/admin/addNew', ['adminMenu' => $adminMenu]);
    ...
    public function show()
    {
        try {
            ...
            $this->view('modules/mod_embedded/mod_pages/admin/edit', ['adminMenu' => $adminMenu]);
